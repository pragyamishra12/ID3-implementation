...
Original file is located at
    https://colab.research.google.com/drive/1DzsrldKEAfeUg0m_uP4aaioTXdk789ai
"""
...
df_tennis= pd.read_csv("PlayTennis.csv") #importing the dataset from the disk
df_tennis.head() #viewing some row of the dataset
